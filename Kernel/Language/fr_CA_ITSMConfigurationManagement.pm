...
sub Data {
    ...
    $Self->{Translation}->{'CPU'} = 'UNITÉ CENTRALE';
    ...
    $Self->{Translation}->{'Desktop'} = 'Bureau';
    ...
    $Self->{Translation}->{'Freeware'} = 'Logiciels gratuits';
    ...
    $Self->{Translation}->{'Investment costs'} = 'Coûts d\'investissement';
