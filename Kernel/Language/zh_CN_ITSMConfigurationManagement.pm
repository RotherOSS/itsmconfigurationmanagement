...
sub Data {
    ...
    $Self->{Translation}->{'Filter by object type'} = '按类型过滤';
    $Self->{Translation}->{'Add DynamicField'} = '添加动态字段';
    ...
    $Self->{Translation}->{'Referenced by'} = 'ACL设置参考';
    ...
    $Self->{Translation}->{'Standard SIM'} = '标准';
